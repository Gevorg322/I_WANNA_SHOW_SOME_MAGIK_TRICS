...
LAT_STEP = 1.008  # Шаги при движении карты по широте и долготе
LON_STEP = 1.02
...
class MapParams(object):
    ...
    def __init__(self):
        self.lat = 55.666  # Координаты центра карты на старте.
        self.lon = 37.666
    ...
    def update(self, event):
        if event.key == 280 and self.zoom < 19:  #клавиша пог ю
            self.zoom += 1
    ...
    def add_reverse_toponym_search(self, pos):
        ...
        self.search_result = SearchResult(point, toponim['metaDataProperty']
        ['GeocoderMetaData']['text'] if toponim else None)
